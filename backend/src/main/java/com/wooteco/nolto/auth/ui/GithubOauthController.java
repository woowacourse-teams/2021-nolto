...
import com.wooteco.nolto.auth.ui.dto.GithubRedirectResponse;
...
public class GithubOauthController {
    ...
    public ResponseEntity<GithubRedirectResponse> githubLogin() {
        return ResponseEntity.ok(new GithubRedirectResponse(this.clientId, this.redirectUri, this.scope));
    }
