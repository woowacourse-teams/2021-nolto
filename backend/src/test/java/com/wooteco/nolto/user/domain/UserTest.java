...
public class UserTest {
    ...
    @Test
    void isLiked() {
        User user = new User(null, SOCIAL_ID, SocialType.GITHUB, NICKNAME, IMAGE);
    ...
    @Test
    void isNotLiked() {
        User user1 = new User(null, SOCIAL_ID, SocialType.GITHUB, NICKNAME, IMAGE);
        User user2 = new User(null, "98765L", SocialType.GOOGLE, "amazzi", IMAGE);
        Feed feed = new Feed("title", "content", Step.PROGRESS, true, "", "", "");
