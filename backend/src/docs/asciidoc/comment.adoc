...
include::{snippets}/comment-findAllByFeedId/http-request.adoc[]
include::{snippets}/comment-findAllByFeedId/path-parameters.adoc[]

==== Response

include::{snippets}/comment-findAllByFeedId/http-response.adoc[]

==== Response Fields

include::{snippets}/comment-findAllByFeedId/response-fields.adoc[]
